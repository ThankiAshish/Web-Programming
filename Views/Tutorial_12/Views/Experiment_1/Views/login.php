...
<head>
  ...
  <title>Tutorial 12.1 Login - (22SOECE13039)</title>
</head>

<body class="bg-secondary">
  <div class="container-fluid d-flex align-items-center justify-content-center" style="height: 100vh">
    <div class="card shadow" style="width: 30%; min-height: 60%; min-width: 350px; padding: 10px">
      <div class="d-flex flex-column h-100 align-items-center">
        <div class="container-fluid d-flex flex-column align-items-center justify-content-center gap-2" style="width: 100%; margin-top: 20px">
        ...
        <form id="userForm" class="container-fluid d-flex flex-column gap-3 mt-3" method='POST' action='../Php/loginController.php'>
